...
class ShlosbergLive(object):
    ...
    def Urls(self):
        ...
        return [
            ...
            # ('https://www.youtube.com/watch?v=cUgP2C7Y7mM', '33', None),
            # ('https://www.youtube.com/watch?v=CuiADlYfjq0', '32', None),
            # ('https://www.youtube.com/watch?v=7pkAydybFCc', '31', None),
            # ('https://www.youtube.com/watch?v=ofL2yRqw9f0', '30-2', None),
            # ('https://www.youtube.com/watch?v=YVSGDJov7cw', '30-1', None),
            # ('https://www.youtube.com/watch?v=XXusqj6xygc', '29', None),
            # ('https://www.youtube.com/watch?v=QBsjBcqFev0', '28', None),
            # ('https://www.youtube.com/watch?v=YttJ60SY7sM', '27', None),
            # ('https://www.youtube.com/watch?v=JPxS1wIjUmc', '26', None),
            # ('https://www.youtube.com/watch?v=QYwTmlN0UdE', '25', None),
            # ('https://www.youtube.com/watch?v=jv_B1PXiQB8', '24', None),
            # ('https://www.youtube.com/watch?v=owBdz-X_SWQ', '23', None),
            # ('https://www.youtube.com/watch?v=HWd9l03xp1k', '22', None),
            # ('https://www.youtube.com/watch?v=ZhmZghs89wA', '21', None),
            # ('https://www.youtube.com/watch?v=72DIC22v1W4', '20', None),
            # ('https://www.youtube.com/watch?v=yXK-AZd2HAw', '19', None),
            # ('https://www.youtube.com/watch?v=fTyN66Sd9Fs', '18', None),
            # ('https://www.youtube.com/watch?v=wov7yvgTEok', '17', None),
            # ('https://www.youtube.com/watch?v=-h_KXVWVEJg', '16', None),
            # ('https://www.youtube.com/watch?v=xb0AsPuGvuc', '15', None),
            # ('https://www.youtube.com/watch?v=p2jOsznpVrk', '14', None),
            # ('https://www.youtube.com/watch?v=x5RDW-SXKA0', '13', None),
            # ('https://www.youtube.com/watch?v=pu_l_4FrRQI', '12', None),
